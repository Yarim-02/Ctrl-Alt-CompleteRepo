 ...
 * @param is_centered
 */
ResumeButton::ResumeButton(const std::string& image_path, std::string button_name, const GameObjectType type,
 ...
 * @return void
 */
void ResumeButton::setAlpha(const Uint8 alpha)
{
	m_alpha = alpha;
}
 ...
 * @return void
 */
void ResumeButton::setActive(const bool value)
{
	m_active = value;
}
