 ...
 * @param is_centered
 */
QuitButton::QuitButton(const std::string& image_path, std::string button_name, const GameObjectType type,
 ...
 * @return void
 */
void QuitButton::setAlpha(const Uint8 alpha)
{
	m_alpha = alpha;
}
 ...
 * @return void
 */
void QuitButton::setActive(const bool value)
{
	m_active = value;
}
