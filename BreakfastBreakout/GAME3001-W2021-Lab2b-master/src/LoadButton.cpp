 ...
 * @param is_centered
 */
LoadButton::LoadButton(const std::string& image_path, std::string button_name, const GameObjectType type,
 ...
 * @return void
 */
void LoadButton::setAlpha(const Uint8 alpha)
{
	m_alpha = alpha;
}
 ...
 * @return void
 */
void LoadButton::setActive(const bool value)
{
	m_active = value;
}
